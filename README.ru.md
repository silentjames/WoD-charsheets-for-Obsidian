...
9. В начало заметки добавить:
    ...
    ```
    ````
    `"/z_Z manuals/WoDCharsheets.js"` - мой путь к JS-скрипту **внутри хранилища** Obsidian, нужно заменить на свой.
...
Для вампиров Дикого Запада - Hagin Caps Medium и Chibola.<br>
Для вампиров Темных Веков - PT Serif Pro и Lidia.<br>
Для оборотней - Marta и KistyCC.<br>
Для оборотней Буйного Запада - Hagin Caps Medium и URWWoodTypD.<br>
Для магов и технократов - Marta и Akvitania Modern.<br>
