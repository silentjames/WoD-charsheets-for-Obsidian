...
//  console.log(document.querySelector(".mod-active .line.clan .statblock-markdown"))
    ...
    var clanName = document.querySelector(".vtm-v20-vampire .line.clan .statblock-markdown > p").innerHTML;
//  console.log(clanName)
    const collapsedColumn = document.querySelector('.vtm-v20-vampire .collapse-container'); // определяется зона, которой будет назначен бэкграунд 
    switch (clanName) { 
        case ('Ассамиты'):
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Assamite-background-logo)"};
            break;
        case ('Антитрибу Ассамитов'):
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Assamite-Antitribu-background-logo)"};
            break;
        case 'Баали':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Baali-background-logo)"};
            break;
        case 'Бруха':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Brujah-background-logo)"};
            break;
        case 'Антитрибу Бруха':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Brujah-Antitribu-background-logo)"};
            break;
        case 'Истинные Бруха':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--True-Brujah-background-logo)"};
            break;
        case 'Каппадокийцы':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Cappadocians-background-logo)"};
            break;
        case 'Каитиф':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Caitiff-background-logo)"};
            break;
        case 'Пандер':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Caitiff-Antitribu-Pander-background-logo)"};
            break;
        case 'Вентру':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Ventrue-background-logo)"};
            break;
        case 'Антитрибу Вентру':
            collapsedColumn.classList.add('Ventrue-Antitribu'); 
            document.querySelector(".weakness .statblock-rendered-text-content").innerHTML = 'Всем Вентру присущ утончённый вкус — в пищу им годится кровь только одной определённой категории смертных. Когда игрок создаёт персонажа‐Вентру, он должен вместе с рассказчиком определить эту категорию. Обратите внимание, что выбор этот окончательный, и после начала игры его уже нельзя будет изменить. Кровь смертных, не относящихся к выбранной категории <br> (в том числе кровь животных), не пополняет запас пунктов крови персонажа вне зависимости <br> от того, сколько он её выпьет, — его просто немедленно стошнит. Категория жертв, кровь которых годится для персонажа‐вентру, может быть как довольно узкой (например, младшие сёстры),  <br>  так и относительно широкой (например, обнажённые подростки). Кровь Сородичей не подпадает под эти ограничения.';
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Ventrue-Antitribu-background-logo)"};
            break;
        case 'Гангрел':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Gangrel-background-logo)"};
            break;
        case 'Дикие Гангрелы':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Country-Gangrel-background-logo)"};
            break;
        case 'Городские Гангрелы':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--City-Gangrel-background-logo)"};
            break;
        case 'Джованни':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Giovanni-background-logo)"};
            break;
        case 'Дочери Какофонии':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Daughters-of-Cacophony-background-logo)"};
            break;
        case 'Киасиды':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Kiasyd-background-logo)"};
            break;
        case 'Ласомбра':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Lasombra-background-logo)"};
            break;
        case 'Малкавиан':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Malkavian-background-logo)"};
            break;
        case 'Антитрибу Малкавиан':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Malkavian-Antitribu-background-logo)"};
            break;
        case 'Носферату':
            ...
            if (document.querySelector(".view-content:has(.wod-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Nosferatu-background-logo)"};
            break;
        case 'Антитрибу Носферату':
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Nosferatu-Antitribu-background-logo)"};
            break;
        case ('Последователи Сета'):
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Followers-of-Set-background-logo)"};
            break;
        case ('Змеи Света'):
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Serpents-of-Light-background-logo)"};
            break;
        case ('Равнос'):
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Ravnos-background-logo)"};
            break;
        case ('Антитрибу Равнос'):
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Ravnos-Antitribu-background-logo)"};
            break;
        case ('Салюбри'):
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Salubri-background-logo)"};
            break;
        case ('Антитрибу Салюбри'):
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Salubri-Antitribu-background-logo)"};
            break;
        case ('Самеди'):
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Samedi-background-logo)"};
            break;
        case ('Тореадор'):
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Toreador-background-logo)"};
            break;
        case ('Антитрибу Тореадор'):
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Toreador-Antitribu-background-logo)"};
            break;
        case ('Тремер'):
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Tremere-background-logo)"};
            break;
        case ('Антитрибу Тремер'):
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Tremere-Antitribu-background-logo)"};
            break;
        case ('Цимисхи'):
            ...
            if (document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".view-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Tzimisce-background-logo)"};
            break;
        }; }
    else {
        //nothing
    ...
    // для ховера - лого клана проставляется рядом с фото, если есть класс vtm-header - все то же самое, в общем. 
    if (document.querySelector(".popover.hover-popover .vtm-v20-vampire .line.clan .statblock-markdown > p") != null) {
    var clanNameHover = document.querySelector(".popover.hover-popover .vtm-v20-vampire .line.clan .statblock-markdown > p").innerHTML;
    const collapsedColumnHover = document.querySelector('.popover.hover-popover .vtm-v20-vampire .collapse-container'); // определяется зона, которой будет назначен бэкграунд 
    switch (clanNameHover) { 
        case ('Ассамиты'):
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
                {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Assamite-background-logo)"};
            break;
        case ('Антитрибу Ассамитов'):
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Assamite-Antitribu-background-logo)"};
            break;
        case 'Баали':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Baali-background-logo)"};
            break;
        case 'Бруха':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Brujah-background-logo)"};
            break;
        case 'Антитрибу Бруха':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Brujah-Antitribu-background-logo)"};
            break;
        case 'Истинные Бруха':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--True-Brujah-background-logo)"};
            break;
        case 'Каппадокийцы':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Cappadocians-background-logo)"};
            break;
        case 'Каитиф':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Caitiff-background-logo)"};
            break;
        case 'Пандер':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Caitiff-Antitribu-Pander-background-logo)"};
            break;
        case 'Вентру':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Ventrue-background-logo)"};
            break;
        case 'Антитрибу Вентру':
            collapsedColumnHover.classList.add('Ventrue-Antitribu'); 
            document.querySelector(".popover.hover-popover .weakness .statblock-rendered-text-content").innerHTML = 'Всем Вентру присущ утончённый вкус — в пищу им годится кровь только одной определённой категории смертных. Когда игрок создаёт персонажа‐Вентру, он должен вместе с рассказчиком определить эту категорию. Обратите внимание, что выбор этот окончательный, и после начала игры его уже нельзя будет изменить. Кровь смертных, не относящихся к выбранной категории <br> (в том числе кровь животных), не пополняет запас пунктов крови персонажа вне зависимости <br> от того, сколько он её выпьет, — его просто немедленно стошнит. Категория жертв, кровь которых годится для персонажа‐вентру, может быть как довольно узкой (например, младшие сёстры),  <br>  так и относительно широкой (например, обнажённые подростки). Кровь Сородичей не подпадает под эти ограничения.';
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Ventrue-Antitribu-background-logo)"};
            break;
        case 'Гангрел':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Gangrel-background-logo)"};
            break;
        case 'Дикие Гангрелы':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Country-Gangrel-background-logo)"};
            break;
        case 'Городские Гангрелы':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--City-Gangrel-background-logo)"};
            break;
        case 'Джованни':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Giovanni-background-logo)"};
            break;
        case 'Дочери Какофонии':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Daughters-of-Cacophony-background-logo)"};
            break;
        case 'Киасиды':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Kiasyd-background-logo)"};
            break;
        case 'Ласомбра':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Lasombra-background-logo)"};
            break;
        case 'Малкавиан':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Malkavian-background-logo)"};
            break;
        case 'Антитрибу Малкавиан':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Malkavian-Antitribu-background-logo)"};
            break;
        case 'Носферату':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Nosferatu-background-logo)"};
            break;
        case 'Антитрибу Носферату':
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Nosferatu-Antitribu-background-logo)"};
            break;
        case ('Последователи Сета'):
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Followers-of-Set-background-logo)"};
            break;
        case ('Змеи Света'):
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Serpents-of-Light-background-logo)"};
            break;
        case ('Равнос'):
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Ravnos-background-logo)"};
            break;
        case ('Антитрибу Равнос'):
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Ravnos-Antitribu-background-logo)"};
            break;
        case ('Салюбри'):
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Salubri-background-logo)"};
            break;
        case ('Антитрибу Салюбри'):
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Salubri-Antitribu-background-logo)"};
            break;
        case ('Самеди'):
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Samedi-background-logo)"};
            break;
        case ('Тореадор'):
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Toreador-background-logo)"};
            break;
        case ('Антитрибу Тореадор'):
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Toreador-Antitribu-background-logo)"};
            break;
        case ('Тремер'):
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Tremere-background-logo)"};
            break;
        case ('Антитрибу Тремер'):
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Tremere-Antitribu-background-logo)"};
            break;
        case ('Цимисхи'):
            ...
            if (document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container") != null) 
            {document.querySelector(".popover.hover-popover .markdown-embed-content:has(.vtm-header) .vtm-v20-vampire .general-info-group > .statblock-inline-item.group-container").style.backgroundImage = "var(--Tzimisce-background-logo)"};
            break;
        }; 
    };
...
//                  ## Планы-задум_очки ##
//\\ 1. Превращать пустоту в нули для характеристик и способностей [DONE]
//\\ 2. Переделать лейаут: [DONE]
//\\		- изъян отдельно по центру; [DONE]
//\\		- специализация под здоровьем; [DONE]
//\\ 		- достоинства, недостатки, специализацию (а также, возможно, основную волю и первую строчку крови) переделать в проперти [DONE]
//\\ 3. Попробовать сделать слэш в совести и самоконтроле побольше [skip]
//\\ 4. Автоматические изъяны для каждого клана? [DONE]
//\\ 5. Сделать ссылки на дисциплины? Точней, лучше добавить правило обработки ссылок, если это они [DONE]
//\\ 6. Мегахитрость, чтобы запасы крови можно было вводить одним числом, а не бить на четыре строчки? [DONE]
//\\ 7. В шрифте с маленькими кружками вернуть на место цифры с 6 по 9? и запилить Х на десятку? Даже не цифры можно вернуть, а просто добавлять кружочки. [DONE]
//\\      - собсно кружочки [DONE]
//\\      - 10 вместо Х [DONE]
//\\      - цифры вместо кружочков для некоторых характеристик, а то не влезет ни пса [DONE]
//\\             font-size: 14px;
//\\             font-family: "Marta";
//\\             margin-top: -2px !important;
//\\      - а для дисциплин можно символы считать, и если их больше скольких-то, а значение больше 5-7 - то уже превращать в цифры
//\\      - ограничения для добродетелей, чтоб не больше 5, надо или нафиг? [skip]
//\\ 8. Все-таки что-то не так с отображением модификатора человечности, если путь - не человечность. [DONE]
//\\ 9. Стрелочки для достоинств, недостаток, крови, воли, и так далее. [DONE]
//\\ 10. Надо таки найти какой-то код для ховера, дефолтный совсем ублюдский - или разобраться, чем я сломал дефолтный) [DONE] и потом еще раз done
//\\ 11. Еще бы понять, как запихнуть скрипт в любую папку, а не только внутре обсидиана. [частично] кое-что можно спрятать внутрь плагина в блок
// 12. Style Setting какой-нибудь попробовать?                                                       с джаваскриптом, но, кажется, не все.
//\\ 13. Статблок можно использовать как красивый хедер, если добавить `cssclass: vtm-header` [DONE]